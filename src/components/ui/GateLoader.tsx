    ...
    <AnimatePresence>
      {isLoading && (
        <div className="fixed inset-0 z-50 flex pointer-events-none">
          ...
          >
            <div className="absolute right-0 top-0 bottom-0 w-[1px] bg-red-primary z-10" style={{ boxShadow: '0 0 15px color-mix(in srgb, var(--theme-primary) 100%, transparent)' }} />
          ...
          >
            <div className="absolute left-0 top-0 bottom-0 w-[1px] bg-red-primary z-10" style={{ boxShadow: '0 0 15px color-mix(in srgb, var(--theme-primary) 100%, transparent)' }} />
          ...
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-slate-900 border-2 border-red-primary rounded-full flex items-center justify-center z-20"
            style={{ boxShadow: '0 0 30px color-mix(in srgb, var(--theme-primary) 50%, transparent)' }}
          >
